                  ...
                  <div className="p-4 md:p-5">
                    {loading ? (
                      <div className="flex gap-3">
                        {[...Array(3)].map((_, i) => (
                          <div key={i} className="flex-1 h-20 bg-zinc-800/50 animate-pulse rounded-lg" />
                        ))}
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-4 border border-dashed border-zinc-700/50 rounded-lg">
                        <div>
                          ...
                          <p className="text-[10px] text-zinc-600 font-mono">Refresh the feed or search for latest stories</p>
                        </div>
